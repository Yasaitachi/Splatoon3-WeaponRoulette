const translations = {
  ja: {
    ...
    'friends-invite-received-title': 'ルームへの招待',
    'friends-invite-received-body': '{name}さんから招待が届きました。',
    'friends-invite-join': '参加する',
    'friends-invite-decline': '辞退する',
    'friends-already-in-room': '参加済み',
    'friends-not-in-room': 'ルームに参加していません。',
  ...
  en: {
    ...
    'friends-invite-received-title': 'Room Invitation',
    'friends-invite-received-body': 'You have received an invitation from {name}.',
    'friends-invite-join': 'Join',
    'friends-invite-decline': 'Decline',
    'friends-already-in-room': 'In Room',
    'friends-not-in-room': 'You are not in a room.',
